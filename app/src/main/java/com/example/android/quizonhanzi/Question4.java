...
public class Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (initVal) {
            ...
            answer1.setText(getResources().getString(R.string.meaning41));
            answer2.setText(getResources().getString(R.string.meaning42));
            answer3.setText(getResources().getString(R.string.meaning43));
        } else {
            question.setText(getResources().getString(R.string.readingOf));
            answer1.setText(getResources().getString(R.string.reading41));
            answer2.setText(getResources().getString(R.string.reading42));
            answer3.setText(getResources().getString(R.string.reading43));
    ...
    public void onRadioButtonClick(View view) {
        ...
        Intent nextQuestion = new Intent(this, Question5.class);
